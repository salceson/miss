...
PARAMS_LIST[0]='COLS=6; ROWS=6; AREA_SIZE=4; TRAFFIC=0.7;  NODES=4; APN=12'
PARAMS_LIST[1]='COLS=5; ROWS=5; AREA_SIZE=4; TRAFFIC=0.7;  NODES=3; APN=12'
PARAMS_LIST[2]='COLS=4; ROWS=4; AREA_SIZE=4; TRAFFIC=0.7;  NODES=2; APN=12'
PARAMS_LIST[3]='COLS=3; ROWS=3; AREA_SIZE=4; TRAFFIC=0.7;  NODES=2; APN=12'
PARAMS_LIST[4]='COLS=2; ROWS=2; AREA_SIZE=4; TRAFFIC=0.7;  NODES=2; APN=12'
PARAMS_LIST[5]='COLS=1; ROWS=1; AREA_SIZE=4; TRAFFIC=0.7;  NODES=1; APN=12'
